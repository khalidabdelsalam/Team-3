...
const compressionJobsTotal = new client.Counter({
  name: 'compression_jobs_total',
  help: 'Total compression jobs by status',
  labelNames: ['status', 'algorithm'],
  registers: [register],
});

const compressionRatioHistogram = new client.Histogram({
  name: 'compression_ratio',
  help: 'Compression ratio distribution',
  buckets: [0.1, 0.3, 0.5, 0.7, 0.9, 1.0, 1.1],
  registers: [register],
});
